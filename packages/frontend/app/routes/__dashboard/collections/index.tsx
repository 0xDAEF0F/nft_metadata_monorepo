      ...
      <div className='m-10 grid grid-cols-3 rounded-lg border-4 border-dashed border-gray-200 p-4'>
        {loaderData.map((item) => (
          <Link key={item.id} to={'' + item.id}>
            <div className='m-3 flex rounded-lg border border-gray-200 bg-white p-6 shadow-md hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700'>
              <div>
