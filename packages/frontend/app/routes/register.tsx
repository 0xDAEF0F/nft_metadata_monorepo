...
export default function Register() {
  ...
  const usernameErrors = actionData?.fieldError?.username?.map((msg, idx) => {
    return (
      <li className="text-red-600 text-xs list-disc" key={idx}>
        {msg}
      </li>
    )
  })
      ...
      <div className="mx-auto max-w-lg">
        ...
        <form
          ...
          <div>
            ...
            {usernameErrors && <ul className="mt-1 ml-4">{usernameErrors}</ul>}
          </div>
          ...
          <div>
            ...
            {passwordErrors && <ul className="mt-1 ml-4">{passwordErrors}</ul>}
          </div>
